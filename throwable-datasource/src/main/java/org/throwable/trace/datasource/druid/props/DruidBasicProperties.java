...
public class DruidBasicProperties {
    ...
    //ip:host/druid/
    @Bean
    @ConditionalOnProperty(prefix = "org.throwable.trace.datasource.druid.stat_enable", havingValue = "true")
    ...
    //匹配所有路径/*
    @Bean
    @ConditionalOnProperty(prefix = "org.throwable.trace.datasource.druid.web_filter_enable", havingValue = "true")
