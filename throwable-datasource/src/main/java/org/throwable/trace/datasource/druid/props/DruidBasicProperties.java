 ...
 */
@Component
@ConfigurationProperties(prefix = "org.throwable.trace.druid")
public class DruidBasicProperties {
    ...
    //ip:host/druid/
    @Bean
    @ConditionalOnProperty(prefix = "org.throwable.trace.druid", name = "stat_enable", havingValue = "true")
    ...
    //匹配所有路径/*
    @Bean
    @ConditionalOnProperty(prefix = "org.throwable.trace.druid", name = "web_filter_enable", havingValue = "true")
