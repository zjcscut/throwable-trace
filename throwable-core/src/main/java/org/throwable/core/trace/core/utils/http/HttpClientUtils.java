 ...
 * params.put("name", "zjc");
 * String re = HttpClientUtils.getInstance()
 ...
 * }
 */
public final class HttpClientUtils implements AutoCloseable {

	private static final Logger log = LoggerFactory.getLogger(HttpClientUtils.class);

	private static final HttpClientUtils single = new HttpClientUtils(); //单例
...
//    private HttpHeader header; //默认请求头
	...
	//返回工具类对象,以便构建链式条件
	public HttpClientUtils setSocketTimeOut(Integer socketTimeOut) {
	...
	//返回工具类对象,以便构建链式条件
	public HttpClientUtils setConnectTimeOut(Integer connectTimeOut) {
	...
	//返回工具类对象,以便构建链式条件
	public HttpClientUtils setConnectRequestTimeOut(Integer connectRequestTimeOut) {
	...
	//返回工具类对象,以便构建链式条件
	public HttpClientUtils setEmptyResult(String emptyResult) {
	...
	//设置是否带文件上传
	public HttpClientUtils setMulti() {
		this.isMulti = true;
		return this;
	}
	...
	//设置是否重试
	public HttpClientUtils setRetry() {
		this.isRetry = true;
		return this;
	}
	...
	//设置最大重试次数
	public HttpClientUtils setMaxRetryCount(Integer maxRetryCount) {
	...
	//设置请求参数
	public HttpClientUtils addParameter(String name, String value) {
